...
public class ComposantView {
    ...
    public static void ajouterMainDoeuvre(List<Client> client, Map<String,String> data, List<Materiel> materiaux){
        ...
        while (true) {
            ...
            MainDoeuvre mainDoeuvre = new MainDoeuvre(nomMainDoeuvre, tauxHoraire, nbrHeures, facteurProd);
            ...
            if (scanner.nextLine().equalsIgnoreCase("n")) {
                ResultatView.calculCoutTotal(client, data, materiaux, mainDoeuvres);
            }
        }
    }
    ...
    public static void ajouterComposants(List<Client> client, Map<String, String> data) {
        ...
        while (true) {
            ...
            Materiel materiel = new Materiel(nomMateril, quantite, coutUnitaire, coutTransport, coefficientQualite);
            ...
            if (scanner.nextLine().equalsIgnoreCase("n")) {
                ajouterMainDoeuvre(client, data, materiaux);
                break;
            }
        }
}
